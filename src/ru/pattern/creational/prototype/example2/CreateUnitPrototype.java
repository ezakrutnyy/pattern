package ru.pattern.creational.prototype.example2;
 ...
 */
public class CreateUnitPrototype {
    private static Random random = new Random();
    private static int amount = 400;

    public static void main(String[] args) {
        CompositeUnit listUnitIdeal = new CompositeUnit();
        File cavalryFile = new File("C:\\Users\\Евгений\\IdeaProjects\\Elearn\\nationfile\\Cavalry.txt");
        File archerFile = new File("C:\\Users\\Евгений\\IdeaProjects\\Elearn\\nationfile\\Archer.txt");
        File infantryFile = new File("C:\\Users\\Евгений\\IdeaProjects\\Elearn\\nationfile\\Infantry.txt");
